...
RUN apk update \
    ...
    && apk --no-cache add nginx php7 php7-common php7-fpm php7-curl php7-sqlite3 php7-pdo_sqlite php7-xml php7-json php7-simplexml php7-session php7-iconv php7-mbstring php7-ctype php7-zip php5-dom \
